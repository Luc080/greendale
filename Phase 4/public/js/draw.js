// ============================================================
// DRAW.JS – Phase 4
// Neu: Schmiede + Casino Gebäude-Designs
// ============================================================
...
// ── SCHMIEDE ──────────────────────────────────────────────────
// (In _drawBuildingExtras ergänzt)
...
function _drawWindows(type, bx, by, W, H, st) {
  ...
  if (type === 'warehouse') {
    ...
    // Schmiedeofen-Fenster (rötlich glühend)
...
function draw() {
  ...
  ctx.fillStyle = sky; ctx.fillRect(0, 0, canvas.width, canvas.height*.4);
