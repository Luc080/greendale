// ============================================================
// DATA.JS – v6.5
// Neu: Unterschiedliche Produktionszeiten, kein Ketten-Tab,
//      Casino-Level, Handel, Münzen
// ============================================================
...
// Produktionszeiten in Sekunden (reell und ungleich)
// PRODUCE_INTERVAL_SEC[type] = Sekunden pro Produktionszyklus
var PRODUCE_INTERVAL_SEC = {
  sawmill:   20,   // Holz: schnell
  quarry:    28,   // Stein: mittel
  farm:      15,   // Weizen: sehr schnell (Ernte)
  well:      12,   // Wasser: schnell
  kitchen:   40,   // Suppe: braucht Kochen
  bakery:    35,   // Brot: etwas schneller als Suppe
  brickyard: 50,   // Ziegel: langsam (Brennofen)
  carpentry: 60,   // Möbel: aufwändig
  smithy:    90,   // Werkzeug: sehr aufwändig
  warehouse: 999,
  townhall:  999,
  casino:    999
};
...
// Gebäude-Farben (BSTYLE) – für 2D-Fallback und UI-Referenz
var BSTYLE = {
...
// ============================================================
// PRODUKTIONS-TIMING (Frames bei 60fps)
// PRODUCE_INTERVAL = Frames für Standard-Zyklus (für Fortschrittsbalken)
// Echte Zeiten kommen aus PRODUCE_INTERVAL_SEC
// ============================================================
var TARGET_FPS       = 60;
var HUNGER_INTERVAL  = 1200; // alle 20 Sek (in Frames)
var MAX_HUNGER       = 5;

// ============================================================
// BEWEGUNGS-PHYSIK – verlangsamt (v6.5)
// ============================================================
var FRICTION    = 0.88;
var ACCEL       = 0.003;  // war 0.006 – halbiert
var ARRIVE_DIST = 0.15;

// ============================================================
// TAGESZYKLUS – v6.5: 4-5 Minuten pro Phase (in Frames bei 60fps)
// 4.5 Min * 60 = 270 Sek * 60fps = 16200 Frames pro Phase
// ============================================================
var DAY_PHASE_FRAMES = 16200; // ~4.5 Minuten pro Phase
